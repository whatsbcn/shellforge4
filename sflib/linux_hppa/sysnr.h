...
#define __NR_sigreturn       (__NR_Linux + 173)
#define __NR_sigaction       (__NR_Linux + 174)
#define __NR_sigprocmask_     (__NR_Linux + 175)
#define __NR_sigpending_      (__NR_Linux + 176)
#define __NR_sigtimedwait    (__NR_Linux + 177)
#define __NR_sigqueueinfo    (__NR_Linux + 178)
#define __NR_sigsuspend      (__NR_Linux + 179)
